                ...
                <div className="col-sm-6 login-section-wrapper">
                    <div className="login-wrapper my-auto">
                        ...
                        <div className="form-group mb-4">
                            ...
                            <input type="password" name="password" className="form-control" placeholder="repeat your passsword" ref={passInputRepeat} onKeyDown={handleKeyDown}/>
                        </div>
                        ...
                        {hasRegisterError && <p className="login-wrapper-footer-text-error">Username or password incorrect.</p>}
